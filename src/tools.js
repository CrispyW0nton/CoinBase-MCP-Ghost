...
export const tools = [
  ...
  },
  {
    ...
    description: "OFFLINE ONLY. Report the full Stage 1 gate over journal data and manifests: credential approval, WS-only/high-confidence/gap-free data, Stage-0 readiness on WS-quality data, and non-test live keyed WS manifest evidence with preflight timing plus matching product/level2 subscription. Opens no socket and places no orders.",
    inputSchema: {
      type: "object",
      properties: {
        symbol: { type: "string", default: "BTC-USD" },
