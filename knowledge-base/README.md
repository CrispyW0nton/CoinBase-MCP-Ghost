...
| Keyed WS data-feed credentials require explicit Stage 1 approval and may not authorize execution | Kleppmann; Harris; Taleb | `src/stage1-approval.js`, `research/STAGE1_CREDENTIALS_DECISION.md` |
